...
不要求所有元素堆在一个句子里；定性 observation 也可以成立，不要求每组结果都有数字。读出观察后，若 reviewer 仍无法据此判断所问 criterion，就在相邻句解释这项结果与该 criterion 的关系；若关系已清楚，直接进入下一项必要 evidence、修改位置或停止。不为每张图补一个同义 mini-conclusion，也不让解释超过该结果能支持的范围。
